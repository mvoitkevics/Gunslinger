 ...
 */
UCLASS()
class GUNSLINGER_API UAT_PlayMontageAndWaitEvent : public UAbilityTask
{
	GENERATED_BODY()
	
public:
    UAT_PlayMontageAndWaitEvent(const FObjectInitializer& ObjectInitializer);
